...
export function preload() {
    ...
    Images.push(loadImage('images/Output.png'));
    ...
    if (lastDoubleClicked instanceof FG) {
        ...
        if (wave instanceof DSBFC) {
            ...
            document.getElementById("cont").innerHTML = "<h4>" + "Modulation Index : " + mi + "<br>" +
                "<br>" + "Total Power of DSB-FC : " + powtdsbfc.toFixed(2) + " Watts" + "<br>" +
                "Effeciency of DSB-FC :" + (dsbfceff * 100).toFixed(2) + "%" + "</h4>";
            ...
            document.getElementById("cont").innerHTML = "<h4>" + "Total Power of DSB-SC : " + powtdsbsc.toFixed(2) + " Watts" + "<br>" +
            ...
            document.getElementById("cont").innerHTML = "<h4>" + "Total Power of SSB : " + powtssbsc.toFixed(2) + " Watts" + "<br>" +
